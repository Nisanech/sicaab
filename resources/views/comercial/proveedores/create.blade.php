...
<div class="container-fluid">
    <div class="form-neon" autocomplete="off">
        <fieldset>
            ...
            {{-- Inicio formulario --}}
            {!! Form::open(array('url'=>'comercial/proveedores', 'method'=>'POST', 'autocomplete'=>'off', 'files'=>'true')) !!}
            {!! Form::token() !!}
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            <label for="ciudad" class="bmd-label-floating">Tipo</label>
            ...
            <br>
            <p class="text-center">
                <a href="{{ url('comercial/proveedores') }}" type="reset" class="btn btn-raised btn-danger btn-sm"><i class="fas fa-window-close"></i> &nbsp; CANCELAR</a>
                &nbsp; &nbsp;
